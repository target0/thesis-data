...
plot "bench_10k_1t.dat" using ($1):($2/10000) w lp ls 1 title "1 worker thread", "bench_10k_2t.dat" using ($1):($2/10000) w lp ls 2 title "2 worker threads", "bench_10k_4t.dat" using ($1):($2/10000) w lp ls 3 title "4 worker threads"
