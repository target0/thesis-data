...
plot "bench_02k_4t.dat" using ($1):($2/10000) w lp ls 1 title "2k req/s", "bench_04k_4t.dat" using ($1):($2/10000) w lp ls 2 title "4k req/s", "bench_10k_4t.dat" using ($1):($2/10000) w lp ls 3 title "10k req/s"
