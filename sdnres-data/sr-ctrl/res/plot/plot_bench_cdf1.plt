...
plot "bench_02k_1t.dat" using ($1):($2/10000) w lp ls 1 title "2,000 req/s", "bench_04k_1t.dat" using ($1):($2/10000) w lp ls 2 title "4,000 req/s", "bench_10k_1t.dat" using ($1):($2/10000) w lp ls 3 title "10,000 req/s"
