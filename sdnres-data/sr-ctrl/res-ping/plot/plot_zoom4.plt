...
set label "Link down" at 90,2 font "Helvetica,19"
set label "IGP convergence" at 120,6 font "Helvetica,19"

set arrow from 170,20 to 200,22 backhead lc rgb "black"
set label "Controller update" at 205,23 font "Helvetica,19"

set arrow from 410,0 to 410,25 nohead lc rgb "red"
set arrow from 440,4 to 440,25 nohead lc rgb "blue"

set label "Link up" at 420,2 font "Helvetica,19"
set label "IGP convergence" at 450,6 font "Helvetica,19"

set arrow from 490,14 to 520,16 backhead lc rgb "black"
set label "Controller update" at 525,17 font "Helvetica,19"
